    ...
    <div id="details" style="display:none">
      <div class="row">
        ...
        <i class="fa fa-trash">删除</i>
          ...
          <table id="table1" data-toggle="table" data-striped="true" data-toolbar="#toolbar1" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-side-pagination="client" data-pagination="true" data-click-to-select="true" data-page-list="[5, 25, 50, All]" data-search="false">
            <thead>
              <tr>
