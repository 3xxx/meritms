    ...
    $('#calendar').fullCalendar({
      ...
      //  		]
        ...
        eventDrop: function(event,delta,revertFunc) {
          ...
          $.ajax({
                type:"post",
                url:"/index/carcalendar/dropcalendar",
        ...
        eventResize: function(event,delta,revertFunc) {
          ...
          $.ajax({
                type:"post",
                url:"/index/carcalendar/resizecalendar",
...
// RGB 转16进制
  ...
  var hexToRgb = function(hex) {
    ...
    // alert(public);
      if (title){  
            $.ajax({
                type:"post",
                url:"/index/carcalendar/addcalendar",
  ...
  function update(){
      ...
      if (title){  
            $.ajax({
                type:"post",
                url:"/index/carcalendar/updatecalendar",
    ...
    function delete_event(){
        if(confirm("您确定要删除吗？")){
            var cid = $("#cid").val();  
              $.ajax({
                type:"post",
                url:"/index/carcalendar/deletecalendar",
                data: {cid:cid},
                success:function(data,status){
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h3 class="modal-title">添加车辆预约</h3>
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h3 class="modal-title">编辑车辆预约</h3>
          </div>
          <div class="modal-body">
            <div class="modal-body-content">
              <div class="form-group must">
