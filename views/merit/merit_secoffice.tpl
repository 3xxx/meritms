  ...
  <div class="tab-content">
    <div class="tab-pane fade in active" id="employee">
      ...
      <div class="form-inline">
        <table id="table" data-toggle="table" data-url="/merit/secofficedata" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-show-export="true" data-query-params="queryParams">
          <thead>
            <tr>
              <th data-formatter="index1" data-halign="center" data-align="center" data-valign="middle">#</th>
              <th data-field="nickname" data-sortable="true" data-halign="center" data-align="center" data-valign="middle">姓名</th>
              <th data-field="number" data-halign="center" data-align="center" data-valign="middle">项数</th>
              <th data-field="marks" data-sortable="true" data-halign="center" data-align="center" data-valign="middle">汇总</th>
    ...
    <div class="modal-dialog" style="width:auto;height:800px;overflow:auto;">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table id="table7" data-toggle="table" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-query-params="queryParams" data-sort-name="ProjectName" data-sort-order="desc" data-page-size="15" data-page-list="[5, 25, 50, All]" data-unique-id="id" data-pagination="true" data-side-pagination="client" data-single-select="true" data-click-to-select="true">
            <thead>
              <tr>
