...
{{template "tpl/T.header.tpl"}}
    ...
    <!-- </div> -->
       ...
       <iframe src="/achievement/secofficeshow" name='main' frameborder="0"  width="100%" scrolling="no" marginheight="0" marginwidth="0" id="iframepage" onload="this.height=100"></iframe> 
    </div>  
